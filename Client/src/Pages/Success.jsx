    ...
    try {
      ...
      if (verifyRes.ok && verifyData.success) {
        ...
        if (retryCount < 3) {
          ...
          setMessage(
            ...
            "Please contact support with your order ID: " + order_id
          );
        }
      }
      ...
      if (retryCount < 3) {
        ...
        setMessage(
          ...
          "Your payment was received. Contact support with order ID: " + order_id
        );
      }
    }
  };
            ...
            <CardContent className="flex flex-col items-center space-y-8 py-14 px-8">
              ...
              <div className="space-y-3">
                <h2 className="text-4xl font-extrabold text-red-400">
                  Payment Failed Please Contact at 77680 00608
                </h2>
          ...
          <CardContent className="flex flex-col items-center space-y-8 py-14 px-8">
            ...
            <div className="space-y-3">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                For any queries, contact us at 77680 00608
              </p>
              <br />
              <p className="text-gray-400 text-sm leading-relaxed">
                We have sent a confirmation email to your registered email address. Please check your inbox (and spam folder) for details.
              </p>
            </div>
